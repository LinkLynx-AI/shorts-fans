...
- [docs/contracts/creator-workspace-metadata-edit-api-contract.md](docs/contracts/creator-workspace-metadata-edit-api-contract.md): creator owner 向け main price / short caption 更新の mutation 契約
