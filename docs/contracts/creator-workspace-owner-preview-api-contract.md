...
- owner preview は `submission package ready`、`pending review`、`approved for publish`、`approved for unlock` といった review gate と独立した private surface であり、review 承認を必須条件にしません。
