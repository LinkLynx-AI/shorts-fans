...
import { useViewerProfileDraft, type ViewerProfileAvatarField } from "../model/use-viewer-profile-draft";
import {
...
function ViewerProfileAvatarField({
  avatar,
  avatarInputKey,
  displayName,
  isSubmitting,
      ...
      >
        ...
        <div className="mt-12 grid gap-6">
          <ViewerProfileTextField
            ...
            disabled={isSubmitting}
            id="fan-viewer-profile-display-name"
            label="Display Name"
          ...
          <ViewerProfileTextField
            ...
            disabled={isSubmitting}
            id="fan-viewer-profile-handle"
            label="Handle"
            onChange={draft.setHandle}
            spellCheck={false}
            type="text"
            value={draft.handle}
          />
