-- name: ListLegacyRecommendedPublicFeedItems :many
SELECT
    s.id,
    s.creator_user_id,
    s.canonical_main_id,
...
-- name: ListRecommendedPublicFeedShortIDs :many
...
scored_recommended AS (
    SELECT
        ...
        (
            ...
            + (
                CASE
                    WHEN sqlc.narg(viewer_user_id)::uuid IS NULL THEN 0
